...
export function PrivacyPage() {
  usePageMeta({
    title: 'Privacy Policy | Chiang Mai Thai Restaurant',
    description:
      "Chiang Mai (BEST THAI STL LLC) SMS privacy policy — how we collect and use your phone number for order-ready notifications.",
    noindex: true,
  })
